...
public class RolePermissionQueryBuilder extends StorableQueryBuilder implements QueryBuilder<RolePermission> {
	...
	private static final String FIND_PARAM_QUERY= "SELECT rolepermissionID,roleID,permissionID FROM roles_permissions WHERE roleID or permissionID in (?)"; 
	
	@Override
	public PreparedStatement buildDelete(RolePermission t, Connection connection)
			throws SQLException {
		return super.buildDelete(t, connection, DELETE_QUERY);
	}

	@Override
	public PreparedStatement buildInsert(RolePermission t, Connection connection)
			throws SQLException {
	...
	@Override
	public PreparedStatement buildUpdate(RolePermission t, Connection connection)
			throws SQLException {
