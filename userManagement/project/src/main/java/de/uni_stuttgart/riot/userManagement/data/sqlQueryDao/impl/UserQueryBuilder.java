...
public class UserQueryBuilder extends StorableQueryBuilder implements QueryBuilder<User> {
    ...
    private static final String FIND_PARAM_QUERY = "SELECT userid, username, pword, pword_salt FROM users ";
    private static final String FIND_ALL_QUERY = "SELECT userid, username, pword, pword_salt FROM users";
