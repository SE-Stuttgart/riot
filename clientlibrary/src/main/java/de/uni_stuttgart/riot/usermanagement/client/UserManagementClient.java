...
import de.uni_stuttgart.riot.commons.rest.usermanagement.RequestError;
...
public class UserManagementClient {
	...
	public void logout() {
		...
		Response r = target.request().header(ACCESS_TOKEN, UserManagementClient.this.currentAuthenticationToken).put(null);
		String s = r.readEntity(String.class);
		System.out.println(s);
		this.logedIn = false;
	}

	private void internalLogin(String path, Object entity) throws Exception {
		Client client = ClientBuilder.newClient();
		...
		if(r.getStatus() >= 400){
			RequestError error = r.readEntity(RequestError.class);
			error.throwIT();
		} else{
	...
	public Response put(final WebTarget target, final String mediaType, final Entity entity) throws Exception {
	...
	public Response post(final WebTarget target, final String mediaType, final Entity entity) throws Exception {
		return this.doRequest(new InternalRequest() {
			public Response doRequest() {
	...
	public Response delete(final WebTarget target, final String mediaType) throws Exception {
		return this.doRequest(new InternalRequest() {
			public Response doRequest() {
	...
	public Response get(final WebTarget target, final String applicationJson) throws Exception {
		return this.doRequest(new InternalRequest() {
			public Response doRequest() {
	...
	public Response doRequest(InternalRequest r) throws Exception {
