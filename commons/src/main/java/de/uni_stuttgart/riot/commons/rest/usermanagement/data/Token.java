 ...
 * submitting the (username,password) credentials again. Attention, issueTime is
...
public class Token extends Storable {
	 ...
	 *            .
	 */
	public Token(Long tokenID, Long userID, String tokenValue,
			String refreshtokenValue, Timestamp issueTime,
			Timestamp expirationTime, boolean valid) {
		super(tokenID);
		this.userID = userID;
	 ...
	 *            .
	 */
	public Token(Long userID, String tokenValue, String refreshtokenValue,
			Timestamp issueTime, Timestamp expirationTime, boolean valid) {
		super(-1L);
		this.userID = userID;
		this.issueTime = issueTime;
		this.expirationTime = expirationTime;
