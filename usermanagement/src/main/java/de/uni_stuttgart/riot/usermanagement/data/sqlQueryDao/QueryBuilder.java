...
/**
 * 
 * This class is used to create the {@link PreparedStatement}s for every operation in {@link DAO}. <br>
 * It is used every {@link SqlQueryDAO}
 * 
 * @author Jonas Tangermann
 * 
 * @param <T>
 *            Type which is handled by the {@link PreparedStatement}s.
 */
public interface QueryBuilder<T extends Storable> {
     ...
     *             internal sql error
     */
    Query buildDelete(T t, Connection connection) throws SQLException;
     ...
     *             internal sql error
     */
    Query buildInsert(T t, Connection connection) throws SQLException;
     ...
     *             internal sql error
     */
    Query buildUpdate(T t, Connection connection) throws SQLException;
     ...
     *             internal sql error
     */
    Query buildFindByID(Long id, Connection connection) throws SQLException;
     ...
     *             internal sql error
     */
    Query buildFindBySearchParam(Collection<SearchParameter> params, Connection connection, boolean or) throws SQLException;

    /**
     * Builds the query for the retrival of all objects knowen to the datasource. <br>
     * <br>
     ...
     */
    Query buildFindAll(Connection connection) throws SQLException;
}
