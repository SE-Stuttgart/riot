...
public class AuthenticationService {
    ...
    /**
     * Refresh an expired access token based on a refresh token. A refresh token will be used to generate a new access and refresh token.
     * A refresh token can only be used once and will be marked invalid when successfully used.
     * 
