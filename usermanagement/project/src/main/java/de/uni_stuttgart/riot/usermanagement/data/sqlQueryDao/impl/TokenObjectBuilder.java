...
public class TokenObjectBuilder implements ObjectBuilder<Token> {
    ...
    public Token build(ResultSet resultSet) throws SQLException {
        return new Token(resultSet.getLong(1), resultSet.getLong(2), resultSet.getString(3),resultSet.getString(4), resultSet.getTimestamp(5), resultSet.getTimestamp(6));
    }
