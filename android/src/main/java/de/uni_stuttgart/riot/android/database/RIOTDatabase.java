...
public class RIOTDatabase extends SQLiteOpenHelper {
    ...
    public RIOTDatabase(Context context, String valueFromIntent) {
        super(context, DATABASE_NAME, null, DATABASE_VERION);
    ...
    public List<Notification> filterNotifications() {
        ...
        return notificationList;
            ...
            // TODO: return the notification list and display them in the activity not in the database class
        
//        NotificationAdapter chapterListAdapter = new NotificationAdapter(context, notificationList);
