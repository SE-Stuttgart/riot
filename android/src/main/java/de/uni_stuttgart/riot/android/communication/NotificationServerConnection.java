...
public class NotificationServerConnection extends AsyncTask<Void, Void, List<Notification>> {
    ...
    public NotificationServerConnection(NotificationScreen notificationScreen, RIOTDatabase database) {
