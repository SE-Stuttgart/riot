...
//        OLDManagementListAdapter OLDManagementListAdapter = new OLDManagementListAdapter(this, getActivity(), R.layout.list_item_managment_list, itemsList);
//        ListView listView = (ListView) getActivity().findViewById(R.id.management_listView);
//        listView.setAdapter(OLDManagementListAdapter);
