...
public class Calendar {
    ...
    {
        Cursor cur = null;
        Uri calendarsURI = CalendarContract.Calendars.CONTENT_URI.buildUpon().appendQueryParameter(CalendarContract.Calendars.ACCOUNT_NAME, account.name)
        ...
        //TODO cur = cr.query(uri, new String[]{Calendars._ID}, selection, selectionArgs, null);
        try {
